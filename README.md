...
Сервис для удаления фона с изображений на основе модели **BiRefNet** в формате ONNX. Предоставляет веб-интерфейс на базе Gradio с тремя вкладками: загрузка изображения, URL и пакетная обработка с сохранением PNG.
